  ...
  return (
    <div className='bg-gray-100 flex flex-col items-center text-[#00254f] md:px-20'>
      ...
      <div className='grid grid-cols-2 gap-8 px-10 md:px-20 mt-8'>
        <div className='flex items-center'>
          <img src='./images/website/video3.png' className='w-full' alt='Video 2' />
        </div>
        <div className='flex flex-col justify-center'>
          <h3 className='text-sm md:text-2xl font-semibold'>Conheça a linha de produtos do Portal do Soninho</h3>
          <h5 className='text-xs sm:text-sm md:text-xl'>Duração: 08:41</h5>
